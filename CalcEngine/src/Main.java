...
public class Main {
    public static void main(String[] args) {
        ...
        //Place value in the array brackets to make space for values since we do not want to initialize with values.
        ...
        //Below, we are declaring the double variable currentResult. For each value in the array results, we are going to print the
